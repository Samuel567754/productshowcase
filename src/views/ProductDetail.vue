      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div class="space-y-3 mb-8">
            ...
            <a :href="whatsappShareUrl" target="_blank" class="flex items-center justify-center w-full py-3 px-4 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
              <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24"><path d="..."/></svg>
              Contact via WhatsApp
            </a>
            <a href="tel:+11234567890" class="flex items-center justify-center w-full py-3 px-4 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
