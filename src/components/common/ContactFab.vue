...
<template>
  <div class="fixed bottom-6 right-6 z-40">
    ...
    <button
      @click="toggleOpen"
      class="w-14 h-14 rounded-full bg-accent-500 text-white flex items-center justify-center shadow-lg hover:bg-accent-600 transition-all duration-300 focus:outline-none"
    >
      <XMarkIcon v-if="isOpen" class="h-6 w-6 animate-spin-slow" />
      <span v-else class="text-xl font-bold">+</span>
    </button>

    <!-- Contact options (displayed when open) -->
