...
<template>
  <footer class="bg-secondary-900 text-secondary-200 py-12">
    <div class="container-custom">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><router-link to="/category/clothes" class="text-secondary-300 hover:text-white transition-colors">Clothes</router-link></li>
            <li><router-link to="/category/shoes" class="text-secondary-300 hover:text-white transition-colors">Shoes</router-link></li>
            <li><router-link to="/category/bags" class="text-secondary-300 hover:text-white transition-colors">Bags</router-link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="#" class="text-secondary-300 hover:text-white transition-colors">About Us</a></li>
            <li><a href="#" class="text-secondary-300 hover:text-white transition-colors">FAQ</a></li>
            <li><a href="#" class="text-secondary-300 hover:text-white transition-colors">Shipping Information</a></li>
            <li><router-link to="/contact" class="text-secondary-300 hover:text-white transition-colors">Contact Us</router-link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li class="flex items-start">
              ...
              <span class="text-secondary-300">123 Fashion Street, Style City, 12345</span>
            </li>
            <li class="flex items-start">
              <span class="text-accent-400 mr-2">📞</span>
              <span class="text-secondary-300">+1 (555) 123-4567</span>
            </li>
            <li class="flex items-start">
              <span class="text-accent-400 mr-2">✉️</span>
              <a href="mailto:info@luxestyle.com" class="text-secondary-300 hover:text-white transition-colors">info@luxestyle.com</a>
            </li>
          </ul>
        </div>
      </div>
